...
function Forgotpassword(){
    ...
    return(
        <div id="loginblock">
            <input id="loginblock1" type="email" placeholder="Enter Your Email" onChange={(e)=>Setdata({...Data,email:e.target.value})}/><br/><br/>
            <input id="loginblock1" type="password" placeholder="Enter A New Password" onChange={(e)=>Setdata({...Data,newpass:e.target.value})}/><br/><br/>
            <input id="loginblock1" type="password" placeholder="Re-Enter Your New Password" onChange={(e)=>Setdata({...Data,cnfnewpass:e.target.value})}/><br/><br/>
            <button id="loginbutton" onClick={(e)=>Resetpassword(e)}>Reset Password</button>
        </div>
    )
}
